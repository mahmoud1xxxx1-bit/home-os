...
class FirestoreHomeStore
  ...
  MaintenanceRecord _maintenanceFromJson(Map<String, dynamic> json, String id) => MaintenanceRecord(
    ...
    cost: (json['cost'] as num?)?.toDouble(), providerId: json['providerId'], phone: json['phone'], nextDue: json['nextDue'] != null ? DateTime.parse(json['nextDue']) : null,
  );
...
with open('C:/Projects/home_os/lib/core/services/firestore_home_store.dart', 'w', encoding='utf-8') as f:
    f.write(code)
