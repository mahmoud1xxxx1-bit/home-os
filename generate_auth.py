...
code = """import 'package:firebase_auth/firebase_auth.dart' as fb;
...
with open('C:/Projects/home_os/lib/features/auth/data/firebase_auth_repository.dart', 'w', encoding='utf-8') as f:
    f.write(code)
